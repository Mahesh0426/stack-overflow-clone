...
import { AnswerDocument, CommentDocument } from "@/types";
...
interface AnswersProps {
  answers: { total: number; documents: AnswerDocument[] };
  questionId: string;
}

const Answers: React.FC<AnswersProps> = ({ answers: _answers, questionId }) => {
        ...
        <div key={answer.$id} className="flex gap-4">
          <div className="flex shrink-0 flex-col items-center gap-4">
            <VoteButtons
              ...
              downvotes={
                answer.downvotesDocuments || { documents: [], total: 0 }
              }
            />
