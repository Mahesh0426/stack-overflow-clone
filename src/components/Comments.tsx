 ...
 * Comments component
 *
 * Displays a list of comments for a given question or answer.
 * Allows users to add new comments.
 *
 * @param {Models.DocumentList<Models.Document>} comments - List of comments to display
 * @param {string} type - Type of comments to display (question or answer)
 * @param {string} typeId - ID of the question or answer
 * @param {string} [className] - Additional CSS classes to apply to the component
 */
/*******  4911cba4-21e7-4a97-90f7-e56875716afd  *******/const Comments = ({
  comments: _comments,
  type,
  typeId,
  className,
